...
public class HomePage extends DriverBase {
	...
	// page factory design
	@CacheLookup
	@AndroidFindBy(xpath = "//android.widget.Button[@resource-id='com.generalstore.mShop.android.shopping:id/skip_sign_in_button']")
	...
	@CacheLookup
	@AndroidFindBy(xpath = "//android.widget.ImageView[@resource-id='com.generalstore.mShop.android.shopping:id/action_bar_burger_icon']")
	@WithTimeout(time = 25, chronoUnit = ChronoUnit.SECONDS)
	public WebElement hamb_menu;

	@CacheLookup
	@AndroidFindBy(xpath = "//android.widget.EditText[@resource-id='com.generalstore.mShop.android.shopping:id/rs_search_src_text']")
	@WithTimeout(time = 25, chronoUnit = ChronoUnit.SECONDS)
